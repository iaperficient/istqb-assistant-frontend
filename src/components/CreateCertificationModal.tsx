...
import { X, Plus, Award, Link2, FileText, Hash, AlertCircle } from 'lucide-react';
...
const CreateCertificationModal: React.FC<CreateCertificationModalProps> = ({
  isOpen,
  onClose,
  onSuccess
}) => {
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-blue-700">
                        <ul className="list-disc list-inside space-y-1">
                          <li>El código debe ser único e identificar claramente la certificación</li>
                          <li>Podrás subir documentos (syllabus y exámenes) después de crear la certificación</li>
                          <li>La URL debe apuntar a la página oficial de ISTQB</li>
                        </ul>
                      </div>
                    </div>
                  </div>
